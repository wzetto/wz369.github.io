...
$(window).on("scroll", function (event) {
  ...
  if (width <= 992) {
	  ...
	  var headerHeight = "320px";
  }
  
  if (delta > 5) {
    document.getElementsByClassName("inner_top background_img_fuji")[0].style.height = "40px";
    ...
    document.getElementsByClassName("inner_top background_img_fuji")[0].style.height = headerHeight;
