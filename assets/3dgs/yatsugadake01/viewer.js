...
function setupPoster() {
  ...
  // The page can load its local preview immediately, without waiting for the manifest.
  // Preserve its versioned URL so a replaced poster bypasses the old cached image.
